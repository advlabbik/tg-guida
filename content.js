...
infoCards: [
  ...
  { id: "whip", icona: "📡", titolo: "Live tracking e codice WHIP",
    corpo: "Durante l'evento ogni partecipante è tracciato con WHIP: amici e famiglia ti seguono in tempo reale, e per noi il tracking è anche uno strumento di sicurezza. Il tuo codice personale arriva con le comunicazioni di settembre ✱ ed è sulla tabellina numerata nel pacco evento: attivalo seguendo le istruzioni che ricevi al ritiro. Il link della live si attiva nei giorni dell'evento ✱ — passalo a chi ti segue da casa.",
    cerca: "live tracking whip codice seguire famiglia amici link tabellina dorsale attivare" },
