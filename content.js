...
/* La scheda del QR personale del ritiro pacco: il motore la mette PRIMA di
   ...
   Il link ?code=&qr= e il codice in chiaro arrivano con l'email transazionale
   del 23/9 (decisione: il QR si vede solo nell'app, l'email non porta
   l'immagine). */
qr: {
...
infoCards: [
  ...
  { id: "whip", tema: "Durante l'evento", icona: "📡", titolo: "Live tracking",
    corpo: "Durante l'evento ogni partecipante è visibile sull'app di live tracking. È anche il modo con cui vediamo quale percorso hai scelto, per questo puoi cambiare idea senza avvisarci. Per attivarlo apri il link WHIP dell'email del 23 settembre e inserisci il PIN che trovi lì: cercando l'evento dentro l'app WHIP non lo trovi.",
    cerca: "live tracking whip seguire diretta famiglia attivare tracciamento pin link email" },
...
infoCards: [
  ...
  { id: "whip", tema: "During the event", icona: "📡", titolo: "Live tracking",
    corpo: "During the event every rider is visible on the live tracking app. It is also how we see which route you chose, which is why you can change your mind without telling us. To activate it, open the WHIP link in the 23 September email and enter the PIN you find there: searching for the event inside the WHIP app will not find it.",
    cerca: "live tracking whip follow family activate tracker pin link email" },
