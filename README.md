...
**23/9/2026 sera — `numero-e-whip`** (cache `tg-guida-v49`): la scheda del QR dice «Numero 2» / «Number 2» invece di «Pettorale» (non è una gara), e la sezione Live mostra la mappa pubblica WHIP `https://www.whip.live/event-tracking/TG26` ([#37](https://github.com/advlabbik/tg-guida/issues/37)), dal vademecum WHIP del 23/9. Il link di adesione con il PIN (`whip.live/in/event/TG26`) è andato ai partecipanti nell'email transazionale del 23/9, non nell'app. La card Info `whip` dice ancora «le istruzioni arrivano prima della partenza»: vero fino all'email, da rivedere se si vuole metterci link e PIN.
